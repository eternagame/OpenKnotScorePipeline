...
def solve(
    ...
    max_timeout = max(conf.runtime for conf in compute_configurations)
    max_cpus = max(conf.cpus for conf in compute_configurations)
    max_gpus = max(conf.gpus for conf in compute_configurations)
